...
@celery_app.task(name="process_document_task", bind=True, max_retries=2, default_retry_delay=30)
def process_document_task(self, document_id: str):
    ...
    try:
        ...
        print("#################")
        print(f"Celery task failed for document {document_id}, retrying. Error: {str(exc)}\n")
