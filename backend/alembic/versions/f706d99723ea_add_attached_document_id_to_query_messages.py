...
def upgrade() -> None:
    """Upgrade schema."""
    op.add_column('query_messages', sa.Column('attached_document_id', sa.Uuid(), nullable=True))
...
def downgrade() -> None:
    """Downgrade schema."""
    op.drop_constraint('fk_query_messages_attached_document_id', 'query_messages', type_='foreignkey')
