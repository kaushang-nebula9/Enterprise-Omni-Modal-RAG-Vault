...
def upgrade() -> None:
    ...
    op.add_column('notifications', sa.Column('related_evaluation_id', sa.Uuid(), nullable=True))
    op.create_foreign_key(None, 'notifications', 'evaluation_runs', ['related_evaluation_id'], ['id'], ondelete='SET NULL')
