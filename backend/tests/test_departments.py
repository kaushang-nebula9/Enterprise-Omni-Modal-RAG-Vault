...
def test_assign_document_to_department(db):
    ...
    role1 = Role(id=uuid.uuid4(), tenant_id=tenant_id, name="Marketing Mgr", parent_role_id=None, department_id=dept.id)
    role2 = Role(id=uuid.uuid4(), tenant_id=tenant_id, name="Marketing Assoc", parent_role_id=None, department_id=dept.id)
    
    # Create a role outside department
    role3 = Role(id=uuid.uuid4(), tenant_id=tenant_id, name="HR Mgr", parent_role_id=None, department_id=None)
