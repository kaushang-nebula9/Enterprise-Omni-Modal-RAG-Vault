  ...
  return (
    <div className="relative inline-block text-left" ref={panelRef}>
      ...
      {isOpen && reportStatus !== null && (
        <div className="absolute right-0 mt-2 w-72 min-w-[280px] bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-lg shadow-xl p-4 z-50 transition-all">
          <ReportStepIndicator
