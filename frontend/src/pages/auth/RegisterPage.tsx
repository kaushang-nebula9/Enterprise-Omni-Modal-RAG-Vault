      ...
      <div className="mb-10 w-full select-none">
        <div className="flex items-center justify-between relative">
          ...
          <div className="flex flex-col items-center flex-1 z-10">
            ...
            <span
              className={`mt-2 text-xs font-semibold ${step >= 1 ? "text-indigo-700 dark:text-indigo-400" : "text-slate-400 dark:text-slate-500"}`}
            >
              Organisation
            </span>
          </div>
          ...
          <div className="flex flex-col items-center flex-1 z-10">
            ...
            <span
              className={`mt-2 text-xs font-semibold ${step >= 2 ? "text-indigo-700 dark:text-indigo-400" : "text-slate-400 dark:text-slate-500"}`}
            >
              Your Details
            </span>
          </div>
          ...
          <div className="flex flex-col items-center flex-1 z-10">
            ...
            <span
              className={`mt-2 text-xs font-semibold ${step === 3 ? "text-indigo-700 dark:text-indigo-400" : "text-slate-400 dark:text-slate-500"}`}
            >
              Verify Email
            </span>
          </div>
