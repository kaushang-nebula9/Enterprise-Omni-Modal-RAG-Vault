    ...
    <div className="flex flex-col gap-8 w-full max-w-3xl mx-auto h-full pb-12 text-slate-800 dark:text-slate-100">
      ...
      <div className="flex flex-col gap-6">
        <section className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-xl p-6 shadow-sm">
          ...
          <form onSubmit={handleProfileUpdate} className="flex flex-col gap-4">
            ...
            <button
              type="submit"
              disabled={
                profileMutation.isPending || fullName === user?.full_name
              }
              className="mt-2 w-fit px-6 bg-indigo-700 dark:bg-indigo-500 hover:bg-indigo-800 dark:hover:bg-indigo-600 text-white rounded-lg py-2.5 font-medium transition-colors disabled:opacity-50"
            >
        ...
        {user && !user.has_password && (
          <section className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-xl p-6 shadow-sm">
            <h2 className="text-lg font-semibold text-slate-800 dark:text-slate-100 mb-2 font-sora">
              Set a Password
            </h2>
            <p className="text-slate-500 dark:text-slate-400 mb-6 text-sm">
              You signed in with Google. Set a password to also log in with
              email.
            </p>
            ...
            >
              ...
              <button
                ...
                className="mt-2 w-fit px-6 bg-indigo-700 dark:bg-indigo-50 text-white rounded-lg py-2.5 font-medium hover:bg-indigo-600 dark:hover:bg-indigo-400 transition-colors disabled:opacity-50"
              >
