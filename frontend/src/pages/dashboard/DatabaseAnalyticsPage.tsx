                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                  {dbStatuses.map((s: any) => {
                    return (
                      <div
                        key={s.connection_id}
                        onClick={() => navigate(`/dashboard/databases/analytics/${s.connection_id}`)}
                ...
                {isAnalyticsLoading ? (
                  ...
                  <div className="flex-1 w-full min-h-[220px]">
                    <ResponsiveContainer width="100%" height="100%">
                      ...
                      >
                        <CartesianGrid strokeDasharray="3 3" vertical={false} className="stroke-slate-500 dark:stroke-slate-800/80" stroke="currentColor" opacity={0.3} />
                        <XAxis
                          dataKey="date"
                          tickFormatter={(str) => {
